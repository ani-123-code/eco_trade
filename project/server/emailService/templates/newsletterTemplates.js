    ...
    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 800px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e5e7eb;">
      ...
      <div style="padding: 30px 25px;">
        <h2 style="color: #064E3B; font-size: 22px; font-weight: 700; margin: 0 0 18px 0; text-align: center;">
          Welcome to ${process.env.APP_NAME || 'Reeown'}!
        </h2>
        ...
        <div style="background-color: #f8fafc; padding: 28px; border-radius: 10px; margin: 24px 0; text-align: center;">
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin: 0 0 16px 0;">
            Thank you for subscribing to our newsletter! We're excited to have you as part of the Sarvin Electronics family.
          </p>
        ...
        <div style="text-align: center; margin: 30px 0;">
          <div style="background: linear-gradient(135deg, #0EA5A4 0%, #056D6A 100%); padding: 16px 32px; border-radius: 8px; display: inline-block; box-shadow: 0 8px 24px rgba(5,109,106,0.08);">
            <p style="color: #ffffff; font-size: 14px; font-weight: 700; margin: 0; text-transform: uppercase; letter-spacing: 0.5px;">
